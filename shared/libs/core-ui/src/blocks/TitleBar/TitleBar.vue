<script lang="ts">
/**
 * TitleBar — the app's custom window chrome (a "block": composed from
 ...
 * wires the window bridge + i18n around it.
 */
...
withDefaults(
  ...
  }>(),
  {
    ...
    menus: () => [],
    isMaximized: false,
    windowControlsLabels: undefined,
  },
);
  ...
  >
    ...
    <div class="flex shrink-0 items-center gap-2 pl-3 pr-1.5">
      <span
        ...
        aria-hidden="true"
      >
        <!-- stroke bumped for optical balance at tiny size (Iconography: size ≤ 12) -->
