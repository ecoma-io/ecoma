 ...
 * actions arriving rather than a panel blinking on (Principles §3 — motion
 * carries cause and effect); both are token-tier and `duration-fast`, and the
 * global reduced-motion rule flattens them together.
 *
