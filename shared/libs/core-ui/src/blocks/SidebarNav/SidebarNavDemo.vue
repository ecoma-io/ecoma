...
const sections: SidebarNavSection[] = [
  {
    items: [
      { icon: LayoutDashboard, label: "Tổng quan", active: true, href: "#" },
      { icon: Workflow, label: "Quy trình", href: "#" },
      { icon: Boxes, label: "Kết nối", href: "#" },
  ...
  },
  {
    label: "Hệ thống",
    items: [
      { icon: Bell, label: "Thông báo", badge: 3, href: "#" },
      { icon: Settings, label: "Cấu hình", href: "#" },
    ],
  },
];
</script>
...
<template>
  <div class="flex flex-col gap-3">
    ...
    >
      <SidebarNav :sections="sections" :collapsed="collapsed" aria-label="Điều hướng chính" />
    </div>
    ...
    <div class="flex items-center gap-2 text-small text-muted-foreground">
      <span id="sidebar-nav-demo-collapsed">Thu gọn còn icon</span>
