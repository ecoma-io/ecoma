...
const props = withDefaults(
  defineProps<{
    ...
    disabled?: boolean;
    /** "sm" is the compressed form for dense chrome — e.g. the status bar density level. */
    size?: "default" | "sm";
  }>(),
  { modelValue: undefined, disabled: false, size: "default" },
);
...
<template>
  ...
  >
    <span
      ...
      style="
        transition:
          left var(--dur-fast) var(--ease-spring),
