...
| R.2  | Publishing policy + luật sư (SUL/CLA/EULA/trademark)                                    | R     | —    | §5 — song song, chặn contributor đầu tiên & mọi publish. Văn bản đã có và **`dev-cli check-contributor-record`** thi hành luật ký nhận; còn lại là corporate CLA                                                                                                                                                                                                                                                                                       |
