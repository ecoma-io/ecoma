...
| R.5  | Build/branch/CI (ô `build` P1) + executor conformance suite                             | R     | —         | **playbook giao hàng (không công bố)**; executor là **`dev-cli conformance`** — đọc freeze và suite của từng gate từ cây, và fail một freeze không có suite (luật #6)                                                                                                                                                                                                                                                                                  |
