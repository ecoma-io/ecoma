...
| R.2  | Publishing policy + luật sư (SUL/CLA/EULA/trademark)                                    | R     | —    | §5 — song song, chặn contributor đầu tiên & mọi publish. Văn bản đã có và **`dev-cli check-contributor-record`** thi hành luật ký nhận; Corporate CLA và Enterprise License đều đã có hiệu lực (sổ license của index là hồ sơ) — phần còn lại là vòng luật sư cho toàn bộ bộ văn bản, điều khoản `cloud/` độc quyền, và các văn bản EULA, trademark                                                                                                    |
