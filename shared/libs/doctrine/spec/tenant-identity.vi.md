...
| **Truy cập support của operator là thành viên, không phải cửa hậu hạ tầng** | Khi nhân viên vận hành phải đọc dữ liệu của một tenant để gỡ lỗi, họ làm với tư cách **principal bên trong tenant đó**: một support Role lấp qua một **grant có Gate, giới hạn thời gian**, mà mỗi lần đọc là một **read event trong chính log của tenant**, mặc định tenant thấy được. Không có đường tầng-hạ-tầng nào đọc dữ liệu tenant mà không hiện trong log của tenant. Grant hết hạn; thu hồi nó là một event | Cùng hình thái với luật §4 rằng nhân viên vận hành là principal thường có Task, Gate và dấu vết — mở rộng từ _hành động control-plane_ sang _support-read dữ liệu tenant_, thứ mà §4 để ngỏ chưa có nhà. Như Invariant 4, tuyên bố phải công khai vì code thi hành nằm nơi người ngoài không audit được; **test thi hành sống trong `cloud/`** còn tuyên bố này sống ở đây |
